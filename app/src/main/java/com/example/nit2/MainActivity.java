...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.nit2.CalendarAdapter calendarAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent Loginintent = new Intent(getApplicationContext(), com.example.nit2.Login_Activity.class);
        ...
        txtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ecoBtnintent = new Intent(getApplicationContext(), com.example.nit2.Camera_Activity.class);
                startActivity(ecoBtnintent);
            }
        });

        calendarRecyclerView = findViewById(R.id.calendarRecyclerView);
        calendarAdapter = new com.example.nit2.CalendarAdapter(this);
    ...
    public void setCalendarList(int year, int month) {
        ...
        List<com.example.nit2.DayModel> dayModelList = new ArrayList<>();
        ...
        try {
            ...
            for (int j = 0; j < dayOfWeek; j++) {
                ...
                com.example.nit2.DayModel dayModel = new com.example.nit2.DayModel();
